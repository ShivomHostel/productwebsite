...
const SmartFeaturesForYou = () => {
	...
	return (
		<div className="h-[17rem] relative bg-gray-50 ml-5 mt-20 max-w-7xl">
			<div className="absolute bg-gray-400 rounded-lg  text-white -top-6 left-5 h-[3rem]  border-black ">
				<h1 className="text-2xl text-center p-1 px-3 font-['PP_Neue_Machina_Inktrap_Medium'] ">
					S-mart Features
				</h1>
            </div>
			...
			<div className="max-w-7xl mx-auto mt-10 ">
				<div className="mt-5">
					<Slider {...settings}>
						{data.map((d) => (
							<div
								className="card border-0 lg:h-[12rem]  shadow"
								style={
									{
