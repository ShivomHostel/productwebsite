...
const Subscription = () => {
	return (
		<div>
			<div className="text-center my-5 font-['PP_Neue_Machina_Inktrap_Medium']">
				<h1 className="uppercase text-3xl ">just one step away </h1>
				<h6>choose one and become a S-Mart family member</h6>
			</div>
			<div className="flex flex-col lg:flex-row  gap-10 lg:gap-2 my-5 mx-2 ">
				<div className="card rounded border-2 lg:w-[35rem]  h-full">
				...
				<div className="card rounded border-2 lg:w-[35rem] border-[#9AD1DE]  h-full">
				...
				<div className="card rounded border-yellow-400  lg:w-[35rem] h-full">
