...
const AboutUs = () => {
	...
	return (
		<>
			<div className="container  mx-auto aboutus">
				<div className="relative w-full">
					<Image
						src="/media/about-bg.jpg"
						alt="One Step Towards"
						layout="responsive"
						width={1000}
						height={900}
					...
					<div className="absolute bottom-3 right-3 ">
						<Link href="https://mystrax.com/ankit/shivom/index.php">
							<button
								type="button"
			...
			<div className="container mx-auto py-12">
				...
				<div className="flex items-center lg:w-[] flex-col lg:flex-row justify-around bg-black text-white">
					<div className="text-center border-r w-[23rem] flex flex-col items-center p-6">
						<Image
					...
					<div className="text-center  w-[23rem] flex flex-col items-center p-6">
						<Image
				...
				<div className="flex items-center  flex-col lg:flex-row  justify-around bg-black text-white mt-3">
					<div className="text-center border-r  w-[23rem] flex flex-col items-center p-6">
						<Image
