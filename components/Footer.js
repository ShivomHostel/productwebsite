								...
								<div class="max-w-sm flex items-center justify-center space-y-3">
									<div className="mt-3 ">
										...
										<div class="flex  rounded-lg shadow-sm h-[3rem]">
											...
											<button
												type="button"
												class="py-3 px-4 w-[16rem] inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-e-md border border-transparent bg-[#D1D5DB] text-black hover:text-white hover:bg-gray-500 disabled:opacity-50 disabled:pointer-events-none"
											>
												Get App
												<svg
													xmlns="http://www.w3.org/2000/svg"
